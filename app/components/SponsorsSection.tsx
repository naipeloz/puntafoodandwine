        ...
        <section className="bg-black py-20 px-6 border-t border-white/10">
            <div className="max-w-4xl mx-auto flex flex-col items-center text-center space-y-16">
                ...
                <div className="flex flex-col items-center space-y-8">
                    <span className="text-[12px] uppercase tracking-[0.2em] text-[#B67784]">Presenta</span>
                ...
                <div className="w-full">
                    {/* <span className="text-[10px] uppercase tracking-[0.2em] text-[#B67784] block mb-6">Medical Partners</span> */}
                    <div className="flex flex-wrap justify-center items-center gap-6 md:gap-8 opacity-80">
                        <img src="/assets/sponsors/BODEGAS/iber/logo.png" alt="Iber" className="h-20 md:h-24 object-contain invert " />
                        <img src="/assets/sponsors/BODEGAS/olivos_de_las_animas/logo_black.png" alt="Olivos de las Animas" className="h-20 md:h-24 object-contain invert " />
                    </div>
                </div>
                ...
                {/* MEDIA PARTNERS */}
                <div className="w-full">
                    <span className="text-[12px] uppercase tracking-[0.2em] text-[#B67784] block mb-6">Media Partners</span>
                    <div className="flex flex-wrap justify-center items-center gap-6 md:gap-8 opacity-80">
                ...
                {/* COMUNICACION */}
                <div className="w-full">
                    <span className="text-[12px] uppercase tracking-[0.2em] text-[#B67784] block mb-6">Comunicación</span>
                    <div className="flex flex-wrap justify-center items-center gap-8 opacity-80">
                ...
                {/* MEDICAL PARTNERS */}
                <div className="w-full">
                    <span className="text-[12px] uppercase tracking-[0.2em] text-[#B67784] block mb-6">Medical Partner</span>
                    <div className="flex flex-wrap justify-center items-center gap-8 opacity-80">
