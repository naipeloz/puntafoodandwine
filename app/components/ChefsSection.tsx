        ...
        <section id="chefs" className="py-20 bg-[#F1EFEA]">
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="flex flex-col items-center text-center md:items-start md:text-left gap-6 md:mt-32">
                        <div className="w-full aspect-[4/5] bg-black/5 relative overflow-hidden rounded-sm">
                            {/* Placeholder for Santiago if no specific image found in assets list, using a Troisgros one temporarily or generic placeholder if allowed. 
                                 Wait, user said "busca en internet y de Santiago Insaurralde". I can't browse freely for images to download. 
                            ...
                            <div className="absolute inset-0 w-full h-full bg-gray-300 flex items-center justify-center text-gray-500">
                                <span className="p-4 text-center">Santiago Insaurralde Image (Placeholder)</span>
                            </div>
                        </div>
                        <div>
                            <h3 className="font-display text-3xl text-black mb-2">Santiago Insaurralde</h3>
                            <p className="text-[#E67E22] uppercase tracking-widest text-xs font-bold mb-4">Argentina / Uruguay</p>
                            <p className="text-black/70 font-light leading-relaxed max-w-lg">
